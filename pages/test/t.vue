	...
	export default {
		data() {
			return {
				...
				//瀑布流webview
				webViewUrl:"/hybrid/html/waterfall2/index.html",
				//曲谱地址
				path:"",
				//曲谱ID
				id:0,
		...
		onLoad(){
			...
			this.path = "http://api.thedream.tech/uploads/download/2019-06-29/5d171f69b7751.xml"
			...
			setTimeout(function(){
				...
				//打开瀑布流页面
				wv = plus.webview.create("/hybrid/html/waterfall2/index.html","__waterfall__",{'uni-app': 'none'})
